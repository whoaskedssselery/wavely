...
import { fetchPlaylists, fetchPlaylistIdsWithTrack, addTrackToPlaylist } from '@/api/playlists.ts'
					...
					return (
						...
						>
							{playlist.cover_path ? (
								...
								<svg className="add-to-playlist__image add-to-playlist__image--placeholder" viewBox="0 0 24 24" fill="none">
									<path
							...
							{alreadyAdded && (
								<span className="add-to-playlist__badge" aria-label="Уже добавлено">
